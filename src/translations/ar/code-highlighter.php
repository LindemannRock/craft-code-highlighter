...
return [
    ...
    '8px - Tiny' => '8px - ضئيل',
    '10px - Very Small' => '10px - صغير جدًا',
    '12px - Small' => '12px - صغير',
    '14px - Normal' => '14px - عادي',
    '16px - Medium' => '16px - متوسط',
    '18px - Large' => '18px - كبير',
    '20px - Very Large' => '20px - كبير جدًا',
    '24px - Huge' => '24px - ضخم',
    ...
    'e.g., JetBrains Mono, Fira Code, monospace' => 'مثلاً: JetBrains Mono، Fira Code، monospace',
    ...
    'Use Plugin Default ({value})' => 'استخدام الافتراضي للإضافة ({value})',
