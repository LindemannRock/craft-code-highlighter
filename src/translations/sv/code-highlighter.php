...
return [
    ...
    '8px - Tiny' => '8px - Pytteliten',
    '10px - Very Small' => '10px - Mycket liten',
    '12px - Small' => '12px - Liten',
    '14px - Normal' => '14px - Normal',
    '16px - Medium' => '16px - Medel',
    '18px - Large' => '18px - Stor',
    '20px - Very Large' => '20px - Mycket stor',
    ...
    'e.g., JetBrains Mono, Fira Code, monospace' => 't.ex. JetBrains Mono, Fira Code, monospace',
    ...
    'Enable Match Braces' => 'Aktivera parentesmatchning',
    ...
    'Use Plugin Default ({value})' => 'Använd plugin-standard ({value})',
