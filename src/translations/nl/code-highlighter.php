...
return [
    ...
    '8px - Tiny' => '8px - Heel klein',
    '10px - Very Small' => '10px - Erg klein',
    '12px - Small' => '12px - Klein',
    '14px - Normal' => '14px - Normaal',
    '16px - Medium' => '16px - Middel',
    '18px - Large' => '18px - Groot',
    '20px - Very Large' => '20px - Erg groot',
    ...
    'e.g., JetBrains Mono, Fira Code, monospace' => 'bijv. JetBrains Mono, Fira Code, monospace',
    ...
    'Use Plugin Default ({value})' => 'Plugin-standaard gebruiken ({value})',
