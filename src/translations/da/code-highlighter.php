...
return [
    ...
    '8px - Tiny' => '8px - Bittelille',
    '10px - Very Small' => '10px - Meget lille',
    '12px - Small' => '12px - Lille',
    '14px - Normal' => '14px - Normal',
    '16px - Medium' => '16px - Mellem',
    '18px - Large' => '18px - Stor',
    '20px - Very Large' => '20px - Meget stor',
    ...
    'Use Plugin Default ({value})' => 'Brug plugin-standard ({value})',
