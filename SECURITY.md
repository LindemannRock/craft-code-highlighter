...
If you discover a security vulnerability in Code Highlighter, please report it privately. **Do not open a public GitHub issue** — public disclosure before a fix is available puts other users at risk.

### Preferred: GitHub private advisory

[Open a private security advisory](https://github.com/LindemannRock/craft-code-highlighter/security/advisories/new). This routes the report directly to maintainers with no public visibility.
...
- XSS in highlighted code blocks
- Language-class or theme-class injection in rendered markup
